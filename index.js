...
let cardInfo = [
    { filename: '2_of_clubs.png', alt: '2' },
    { filename: '2_of_diamonds.png', alt: '2' },
    { filename: '2_of_hearts.png', alt: '2' },
    { filename: '2_of_spades.png', alt: '2' },

    { filename: '3_of_clubs.png', alt: '3' },
    { filename: '3_of_diamonds.png', alt: '3' },
    { filename: '3_of_hearts.png', alt: '3' },
    { filename: '3_of_spades.png', alt: '3' },

    { filename: '4_of_clubs.png', alt: '4' },
    { filename: '4_of_diamonds.png', alt: '4' },
    { filename: '4_of_hearts.png', alt: '4' },
    { filename: '4_of_spades.png', alt: '4' },

    { filename: '5_of_clubs.png', alt: '5' },
    { filename: '5_of_diamonds.png', alt: '5' },
    { filename: '5_of_hearts.png', alt: '5' },
    { filename: '5_of_spades.png', alt: '5' },

    { filename: '6_of_clubs.png', alt: '6' },
    { filename: '6_of_diamonds.png', alt: '6' },
    { filename: '6_of_hearts.png', alt: '6' },
    { filename: '6_of_spades.png', alt: '6' },

    { filename: '7_of_clubs.png', alt: '7' },
    { filename: '7_of_diamonds.png', alt: '7' },
    { filename: '7_of_hearts.png', alt: '7' },
    { filename: '7_of_spades.png', alt: '7' },

    { filename: '8_of_clubs.png', alt: '8' },
    { filename: '8_of_diamonds.png', alt: '8' },
    { filename: '8_of_hearts.png', alt: '8' },
    { filename: '8_of_spades.png', alt: '8' },

    { filename: '9_of_clubs.png', alt: '9' },
    { filename: '9_of_diamonds.png', alt: '9' },
    { filename: '9_of_hearts.png', alt: '9' },
    { filename: '9_of_spades.png', alt: '9' },

    { filename: '10_of_clubs.png', alt: '10' },
    { filename: '10_of_diamonds.png', alt: '10' },
    { filename: '10_of_hearts.png', alt: '10' },
    { filename: '10_of_spades.png', alt: '10' },

    { filename: 'ace_of_clubs.png', alt: 'ace' },
    { filename: 'ace_of_diamonds.png', alt: 'ace' },
    { filename: 'ace_of_hearts.png', alt: 'ace' },
    { filename: 'ace_of_spades.png', alt: 'ace' },

    { filename: 'jack_of_clubs.png', alt: 'jack' },
    { filename: 'jack_of_diamonds.png', alt: 'jack' },
    { filename: 'jack_of_hearts.png', alt: 'jack' },
    { filename: 'jack_of_spades.png', alt: 'jack' },

    { filename: 'king_of_spades.png', alt: 'king' },

    { filename: 'queen_of_clubs.png', alt: 'queen' },
    { filename: 'queen_of_diamonds.png', alt: 'queen' },
    { filename: 'queen_of_hearts.png', alt: 'queen' },
    { filename: 'queen_of_spades.png', alt: 'queen' },
];
        ...
        if(action == true){
            ...
            if (host.length != 0){
                if (player1.length != 0){
                    ...
                    updateText("Host picked the " + player1[temp].src.replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png", ''))
                    ...
                    updateText("Host picked the " + player2[temp].src.replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png", ''))
                    ...
                    updateText("Host picked the " + player3[temp].src.replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png", ''))
