        ...
        if(action == true){
            ...
            if (host.length != 0){
                if (player1.length != 0){
                    ...
                    updateText("Host picked the " + (decodeURIComponent(player1[temp].src)).replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png",' '))
                    ...
                    updateText("Host picked the " + (decodeURIComponent(player2[temp].src)).replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png",' '))
                    ...
                    updateText("Host picked the " + (decodeURIComponent(player3[temp].src)).replace("https://armirlako.github.io/Card-Game/imgs/", '').replace(".png",' '))
