        ...
        if(action == true){
            ...
            if (host.length != 0){
                if (player1.length != 0){
                    ...
                    updateText("Host picked the " + player1[temp].src.replace("http://127.0.0.1:5500/imgs/", '').replace(".png", ''))
                    ...
                    updateText("Host picked the " + player2[temp].src.replace("http://127.0.0.1:5500/imgs/", '').replace(".png", ''))
                    ...
                    updateText("Host picked the " + player3[temp].src.replace("http://127.0.0.1:5500/imgs/", '').replace(".png", ''))
